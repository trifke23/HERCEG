...
const sectionImages = [
	...
	const menuData: MenuSection[] = [
	{
		...
		items: [
			...
			{ name: 'Буткица', price: '1400 РСД/кг' },
			{ name: 'Џем', price: '1100 РСД/кг' },
		],
	},
	{
		title: 'РОЛАТИ',
	...
	},
	{
		...
		items: [
			...
			{ name: 'Печурке', price: '1450 РСД/кг' },
		],
	...
	},
	{
		...
		items: [
			...
			{ name: 'Пита са печуркама', price: '1350 РСД/ком' },
	...
	},
	{
		...
		items: [
			{ name: 'Торта Маковњача', price: '1500 РСД/кг' },
			{ name: 'Пита бундевара', price: '1300 РСД/кг' },
			{ name: 'Принцес крофне- 20ком', price: '2000 РСД' },
			{ name: 'Кифлице са џемом', price: '1000 РСД/кг' },
		],
	}
];
